...
export async function POST(request) {
  ...
  const maid = await Maid.create({ name, fathersName, grandFathersName, imageUrl, imageKey, pricePerMonth,pricePerHour, experience, review, category, documentUrl, documentKey, documentName, isAvailable, languages });
